...
import 'package:foody/bloc/blocUnit/StringValueBloc.dart';
...
class SignInWebDesktop extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _SignInWebDesktopState();

}


class _SignInWebDesktopState extends State<SignInWebDesktop> {
  ...
  //Init Blocs
  StringValueBloc stringValueBloc = StringValueBloc();
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            children: [
                              ...
                              Center(
                                child: Container(
                                  width: MediaQuery.of(context).size.width > 1000 ? (MediaQuery.of(context).size.width / 2)  - 150 : (MediaQuery.of(context).size.width / 2)  - 60,
                                  height:  MediaQuery.of(context).size.width > 1000 ? (MediaQuery.of(context).size.width / 2)  - 190 : (MediaQuery.of(context).size.width / 2)  - 60,
