...
class ChartAndroidMobilePortrait extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // drawer: DrawerApp(2 , context , _scaffoldState , true),
      // appBar: AppBar(
      ...
      //   leading: IconButton(
      //     onPressed: (){
      //       print('drawer is : ${_scaffoldState.currentState!.isDrawerOpen}');
