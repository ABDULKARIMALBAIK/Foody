...
class SplashScreenWebTablet extends StatefulWidget{
  @override
  State<StatefulWidget> createState()  => _SplashScreenWebTabletState();
}

class _SplashScreenWebTabletState extends State<SplashScreenWebTablet>{
