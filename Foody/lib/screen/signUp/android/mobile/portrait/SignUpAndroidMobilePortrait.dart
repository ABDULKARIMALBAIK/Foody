...
class SignUpAndroidMobilePortrait extends StatelessWidget{
  ...
  //Init Blocs
  late StrongPasswordBloc strongPassword;
  late SignUpPickImageBloc pickedFileBloc;
  ...
  SignUpAndroidMobilePortrait(){
    ...
    strongPassword = StrongPasswordBloc();
    pickedFileBloc = SignUpPickImageBloc();
  }
                  ...
                  children: [
                    Flexible(
                      child: AutoSizeText(
                          ...
                          style: Theme.of(context).textTheme.bodyText1!.copyWith(color: Theme.of(context).dividerColor),
                          minFontSize: 8,
                          maxLines: 2,
                          overflow: TextOverflow.ellipsis
                      ),
                  ...
                  child: AutofillGroup(
                    child: Column(
                      children: [
                                            ...
                                            Expanded(
                                              child: Padding(
                                                ...
                                                child: Center(
                                                  child: AutoSizeText(
                                                      state.typeName,
                                                      style: Theme.of(context).textTheme.headline6!.copyWith(color: state.colorName),
                                                      minFontSize: 10,
                                                      maxLines: 1,
                                                      overflow: TextOverflow.ellipsis
                                                  ),
                                                                  ...
                                                                  <body>
                                                                    ...
                                                                    <form action="?" method="POST">
                                                                      <div class="g-recaptcha" 
                                                                        data-sitekey="6Leu97wcAAAAAAAbaRA12MTaw3XDreM4Lg8ckS2n"
                        ...
                        //////////////////////// * Sign up button * ////////////////////////
                        AnimatedButton(Theme.of(context).primaryColor, AppLocalizations.of(context)!.translate('signUp_title'),
                                () async{
                        ...
                        AnimatedIconButton(
                            ...
                            darkMode ? Colors.purpleAccent : Colors.purple,
                                () async{
                              isPickedImage ?
                              viewModel.signUpGoogleMobile(context, _scaffoldKey , pickedFile)
                                  :
                              SnakBarBuilder.buildAwesomeSnackBar(
                                  context,
                                  AppLocalizations.of(context)!.translate('signUp_button_snackBar_pick_image'),
                        ...
                        AnimatedIconButton(
                            ...
                            darkMode ? Color(0xFF005BFF) : Color(0xFF005BFF),
                                () async{
                              isPickedImage ?
                              viewModel.signUpFacebookMobile(context, _scaffoldKey , pickedFile)
                                  :
                              SnakBarBuilder.buildAwesomeSnackBar(
                                  context,
                                  AppLocalizations.of(context)!.translate('signUp_button_snackBar_pick_image'),
                        ...
                        AnimatedIconButton(
                            ...
                            darkMode ? Colors.lightGreen : Colors.green,
                                () async{
                              isPickedImage ?
                              viewModel.signUpMicrosoftMobile(context, _scaffoldKey , pickedFile)
                                  :
                              SnakBarBuilder.buildAwesomeSnackBar(
                                  context,
                                  AppLocalizations.of(context)!.translate('signUp_button_snackBar_pick_image'),
