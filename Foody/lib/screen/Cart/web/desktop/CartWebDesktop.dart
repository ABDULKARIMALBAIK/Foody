...
class CartWebDesktop extends StatelessWidget{
        ...
        child: Container(
          ...
          child: Row(
            children: [
              Expanded(
                  flex: 1,
                  child: DrawerApp(1 , context , _scaffoldState , false)
              ),
              Expanded(
                flex: 4,
  ...
  buildCartItem(BuildContext contextt, FoodTable cart, int index, Animation<double> animation) {
    ...
    //Check image of cart
    print('cart image is : ${cart.img}');
    print('cart image is : ${cart.blurhashImg}');
