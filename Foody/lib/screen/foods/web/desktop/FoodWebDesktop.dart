...
class FoodWebDesktop extends StatefulWidget{

  @override
  _FoodWebDesktopState createState() => _FoodWebDesktopState();
}

class _FoodWebDesktopState extends State<FoodWebDesktop> with TickerProviderStateMixin{
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Expanded(
                  flex: 1,
                  child: DrawerApp(0 , context , _scaffoldKey , false)
              ),
                                                  ...
                                                  child: StreamBuilder<QuerySnapshot>(
                                                      ...
                                                      builder: (context , AsyncSnapshot<QuerySnapshot> snapshotFoods){
                                                        ...
                                                        if(isFirstTimeFoods){
                                                          ...
                                                          print('foods size b is : ${foods.length}');
                                                          foods.clear();
                                                          foods = [];
                                                          snapshotFoods.data!.docs.forEach((DocumentSnapshot document){
                                                            Map<String, dynamic> data = document.data()! as Map<String, dynamic>;
                                                            print('id of food is : ${document.id}');
                                                            ...
                                                            children: [
                                                              LiveGrid.options(
                                                                ...
                                                                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                                                    childAspectRatio: MediaQuery.of(context).size.width/(MediaQuery.of(context).size.height * 2.4) ,  // width/height children 250/340
                                                                    crossAxisCount: 3,
                                  ...
                                  builder: (context , followLink){
                                    return InkWell(
                                      onTap: (){
                                        ...
                                        VxNavigator.of(context).push(Uri(path: Routers.foodDetailRoute , queryParameters: {"name":food.name}) ,params: food);
                                      },
                                      borderRadius: BorderRadius.circular(16),
                                      child: Column(
                                        mainAxisAlignment: MainAxisAlignment.start,
    ...
    return Padding(
      ...
      child: BlocProvider<AnimatedSearchBloc>(
        ...
        child: BlocBuilder<AnimatedSearchBloc,AnimatedSearchState>(
          buildWhen: (oldState,newState) => oldState != newState,
          builder: (context,stateSearch) => Container(
            height: 48,  //Was 100
            width: 500,  //Was 250
            ...
            child: MouseRegion(
              ...
              child: AnimatedContainer(
                duration: Duration(milliseconds: 375),
                height: 48.0,
                width: !stateSearch.toggle ? 48.0 : 500.0,   //Was 48 : 250
                curve: Curves.easeOut,
                decoration: BoxDecoration(
                  color: Theme.of(context).cardColor,
                  ...
                  children: [
                    ...
                    AnimatedPositioned(
                      ...
                      child: AnimatedOpacity(
                        opacity: !stateSearch.toggle ? 0.0 : 1.0,
                            ...
                            child: GestureDetector(
                              ...
                              child: AnimatedBuilder(
                                child: Icon(
                                  Icons.mic,
                                  size: 20.0,
                                  color: !stateSearch.toggle ?  Theme.of(context).textTheme.bodyText1!.color : Theme.of(context).primaryColor,
                                ),
                    ...
                    AnimatedPositioned(
                      ...
                      top: 2,  //11
                      bottom: 1,
                      left: !stateSearch.toggle ? 20.0 : 50.0,  //40
                      curve: Curves.easeOut,
