...
class FoodWebMobile extends StatefulWidget{
  @override
  State<StatefulWidget> createState() => _FoodWebMobileState();

}

class _FoodWebMobileState extends State<FoodWebMobile> with TickerProviderStateMixin{
          ...
          builder: (context,stateSearch) => Container(
            ...
            child: MouseRegion(
              ...
              child: AnimatedContainer(
                duration: Duration(milliseconds: 375),
                height: 48.0,
                width: !stateSearch.toggle ? 48.0 : 445.0,   //Was 48 : 250
                curve: Curves.easeOut,
                decoration: BoxDecoration(
                  color: Theme.of(context).cardColor,
