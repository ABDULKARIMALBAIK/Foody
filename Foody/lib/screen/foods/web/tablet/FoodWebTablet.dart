...
class FoodWebTablet extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _FoodWebTabletState();

}

class _FoodWebTabletState extends State<FoodWebTablet> with TickerProviderStateMixin{
                                                              ...
                                                              children: [
                                                                LiveGrid.options(
                                                                  ...
                                                                  gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                                                                    childAspectRatio: MediaQuery.of(context).size.width/ (MediaQuery.of(context).size.height * 1.5),  // width/height children   //250/340
                                                                    crossAxisCount: 2,
          ...
          builder: (context,stateSearch) => Container(
            ...
            child: MouseRegion(
              ...
              child: AnimatedContainer(
                duration: Duration(milliseconds: 375),
                height: 48.0,
                width: !stateSearch.toggle ? 48.0 : 470.0,   //Was 48 : 250
                curve: Curves.easeOut,
                decoration: BoxDecoration(
                  color: Theme.of(context).cardColor,
