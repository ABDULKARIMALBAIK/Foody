...
class HomeWebTablet extends StatelessWidget {
...
//controller.scannerViewCreated!.call();
//     //Scaffold Key
//     GlobalKey<ScaffoldState> _scaffoldKey = GlobalKey<ScaffoldState>();
//
//     //Init ViewModel
//     HomeViewModel viewModel = HomeViewModel();
//     // viewModel.listen(context, _scaffoldKey);
//
//     return Scaffold(
//       key: _scaffoldKey,
//       body: SafeArea(
...
//               children: [
//                 TextButton(
//                   onPressed: () => VxNavigator.of(context).push(Uri(path: Routers.signUpRoute)),
//                   child: Text('Sign Up' , style: TextStyle(fontSize: 25, fontWeight: FontWeight.normal , color: Colors.black),),
//                 ),
//                 TextButton(
//                   onPressed: () => VxNavigator.of(context).push(Uri(path: Routers.signInRoute)),
//                   child: Text('Sign In' , style: TextStyle(fontSize: 25, fontWeight: FontWeight.normal , color: Colors.black),),
//                 ),
//               ],
//             )